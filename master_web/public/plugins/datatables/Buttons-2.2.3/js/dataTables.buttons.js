...
$.extend( Buttons.prototype, {
	...
	{
		console.log(_dtButtons, '_resolveExtends')
		var that = this;
		var dt = this.s.dt;
		var i, ien;
		var toConfObject = function ( base ) {
			console.log(1, base, 'toConfObject')
			var loop = 0;
			...
			while ( ! $.isPlainObject(base) && ! Array.isArray(base) ) {
				...
				if ( typeof base === 'function' ) {
					...
					console.log('base', base, 'call', _dtButtons.excelHtml5.available)
			...
			console.log(5, base, Array.isArray( base ) , 'toConfObject')
		...
		console.log(1, conf, '_resolveExtends')
		...
		while ( conf && conf.extend ) {
			...
			console.log(2, objArray, 'objArray')
